...
function usePetApply$1() {
  ...
  const { model, id, isSingleType } = admin.unstable_useContentManagerContext();
  const [status, setStatus] = React__namespace.useState("loading");
  const [petApplies, setPetApplies] = React__namespace.useState([]);
  const refetchPetApplies = React__namespace.useCallback(async () => {
    try {
...
function usePetApply() {
  ...
  const { model, id, isSingleType } = admin.unstable_useContentManagerContext();
  const [status, setStatus] = React__namespace.useState("loading");
  const [record2, setRecord] = React__namespace.useState([]);
  const refetchRecord = React__namespace.useCallback(async () => {
    try {
      const { data } = await fetchClient.get(
...
const { networkConfig, useNetworkVariable, useNetworkVariables } = dappKit.createNetworkConfig({
  testnet: {
...
function Providers({ children }) {
  return /* @__PURE__ */ jsxRuntime.jsx(reactQuery.QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntime.jsx(dappKit.SuiClientProvider, { networks: networkConfig, defaultNetwork: network, children: /* @__PURE__ */ jsxRuntime.jsx(dappKit.WalletProvider, { children }) }) });
}
...
const CreateContractForm$1 = ({ petApply }) => {
  ...
  const [recordTimes, setRecordTimes] = React.useState(0);
  const fetchClient = admin.useFetchClient();
...
const HomePage = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Providers, { children: /* @__PURE__ */ jsxRuntime.jsxs(
    designSystem.Box,
    {
      ...
      width: "100%",
      children: [
        model === "api::pet-apply.pet-apply" && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(dappKit.ConnectButton, { children: "连接钱包" }),
          /* @__PURE__ */ jsxRuntime.jsx(CreateContractForm$1, { petApply: petApplies })
        ] }),
        model === "api::record.record" && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(dappKit.ConnectButton, { children: "连接钱包" }),
          /* @__PURE__ */ jsxRuntime.jsx(CreateContractForm, { record: record2 })
        ] })
      ]
    }
  ) });
