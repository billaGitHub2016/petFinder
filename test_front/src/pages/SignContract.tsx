...
import {getFirstSuiCoinObjectId, signContract} from "@/lib/contracts";
import {networkConfig, suiClient} from "@/networkConfig.ts";
import {SUI_SYSTEM_STATE_OBJECT_ID, SUI_TYPE_ARG} from "@mysten/sui/utils";
...
const SignContract = () => {
    ...
    const [suiCoinObjectId] = useState('');
